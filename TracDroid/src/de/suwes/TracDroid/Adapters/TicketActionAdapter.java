...
public class TicketActionAdapter extends ArrayAdapter<TicketAction> 
{
    private List<TicketAction> m_arrayList = null;
    ...
    /**
        ...
        */
    public TicketActionAdapter(Context context, int textViewResourceID, List<TicketAction> arr) 
    {
